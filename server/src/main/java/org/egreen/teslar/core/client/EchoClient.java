package org.egreen.teslar.core.client;

import org.egreen.teslar.core.server.TeslarEchoServer;
import org.egreen.teslar.core.server.filter.ClientFilter;
    ...
    private static final Logger logger = Grizzly.logger(EchoClient.class);
        ...
        public static void main(String[] args) throws IOException,
            ...
            try {
                ...
                Future<Connection> future = transport.connect(TeslarEchoServer.HOST,
                        TeslarEchoServer.PORT);
